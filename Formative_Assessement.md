...
## Introduction
A cornerstone of every successful business is identifying potential customers, informing them of your service or product and incetivisimg them to become a customer. This process is called marketing. However, customers are complex and not all people are potential customers. The solution is targeted marketing; segmenting the population into distinct groups and approaching the ones most interested in the service in a systematic  manner. The emergence of internet advertainment has allowed companies to target potential customers with greater precision than ever before. Data is now collected on advertisement conversion ratios allowing companies to know exactly how successful a marketing campaign was.\
...
An immediate anomaly is that 2,175 individuals are listed as having an age of 118. These individuals do not have additional information available about them such as income or gender. It is unlikely that this many 118 year olds people are customers and suggesst that this is the default value if age data is not given.  This is further supported by transactions that are recorded for this demographic. It appears there individuels are customer about whom not all information is known. Customers with an age of 118 do spend less and are a statistically distinct group.\
![image](https://user-images.githubusercontent.com/47631827/154353983-05037655-25e8-483d-a400-cdba98cfe026.png)
\
The image above is a histogram of the distibution of ages. 118 is a clear outlier.
...
Beyond the provided customer data of age and annual income, the researcher are considering applying several variables into the clustering algorithm.
- The number of transactions a customer initiated could be used to identify repeat customers.
- The total spend per customer to know how much the clients spend on average over the promotional period.
- The average spend per year per customer can be derived by dividing total spend by the duration the customer has been active. This is important because it allows a long-term customer and a new customer to be compared in a fair manner.
